...
import com.ripostelabs.carlauncher.data.FavoritesStore // v3.0
import com.ripostelabs.carlauncher.data.IgnitionSession // v0.4.7.1
import com.ripostelabs.carlauncher.data.DayNightMode // v0.6
...
import com.ripostelabs.carlauncher.input.LauncherFocus // v0.8 SWC navigation
...
import com.ripostelabs.carlauncher.ui.HomeScreen
import com.ripostelabs.carlauncher.ui.LocalCarFeedback // v2.5
import com.ripostelabs.carlauncher.ui.MediaScreen // v2.6
import com.ripostelabs.carlauncher.ui.ContinueWatchingScreen // v2.7
import com.ripostelabs.carlauncher.ui.NotificationShelfScreen // v2.7
import com.ripostelabs.carlauncher.ui.ParkedOnly // v2.5
import com.ripostelabs.carlauncher.ui.ProfilesScreen // v3.0
...
import com.ripostelabs.carlauncher.ui.settings.SettingsHost // v1.1 settings suite
import com.ripostelabs.carlauncher.ui.settings.SettingsRoute
import com.ripostelabs.carlauncher.ui.ThemeEditorScreen
import com.ripostelabs.carlauncher.ui.ThemesScreen
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        speechController = com.ripostelabs.carlauncher.media.SpeechController(applicationContext).also {
            ...
            it.observeNotifications(
                lifecycleScope,
                combine(
                    com.ripostelabs.carlauncher.notif.NotificationRepository.items,
 ...
 * An unknown speed ([com.ripostelabs.carlauncher.carlib.GpsSpeedSource.SPEED_UNKNOWN], negative) passes,
